...
def main():
    ...
    print("Begin AgglomerativeClustering Method !")
    ...
    picklefilename='silhouette_avgscores_AgglomerativeClustering _ML.sa'
    print(picklefilename)
    # create pickle file for further use 
    pickle.dump(aag_silh_score,open(picklefilename,'wb'), protocol=4)
    picklefilename='silhouette_samples_AgglomerativeClustering _ML.sa'
